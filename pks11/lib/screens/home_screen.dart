...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final String _name = 'Ваше имя'; // Замените на актуальное значение
  final String _email = 'ваш_email@gmail.com'; // Замените на актуальное значение
  final String _phone = 'Ваш номер телефона'; // Замените на актуальное значение
